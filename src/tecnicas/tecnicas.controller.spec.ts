...
describe('TecnicasController', () => {
  ...
  describe('update', () => {
    ...
    it('should throw NotFoundException if id does not exist', async () => {
      await expect(controller.update('999', { nombre: 'No existe' })).rejects.toThrow(NotFoundException);
    });
  });
